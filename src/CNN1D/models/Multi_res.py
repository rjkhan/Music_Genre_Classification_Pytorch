...
class MSResNet(nn.Module):
    def __init__(self, hparams, layers=[1, 1, 1, 1]):
        self.inplanes3 = 64
        self.inplanes5 = 64
        self.inplanes7 = 64
        ...
        self.conv1 = nn.Conv1d(hparams.num_mels, 64, kernel_size=7, stride=4, padding=3,
                               bias=False)
        self.bn1 = nn.BatchNorm1d(64)
        self.relu = nn.ReLU(inplace=True)
        self.maxpool = nn.MaxPool1d(kernel_size=3, stride=4, padding=1)

        self.layer3x3_1 = self._make_layer3(BasicBlock3x3, 64, layers[0], stride=4)
        self.layer3x3_2 = self._make_layer3(BasicBlock3x3, 128, layers[1], stride=4)
        self.layer3x3_3 = self._make_layer3(BasicBlock3x3, 256, layers[2], stride=4)
        ...
        self.layer5x5_1 = self._make_layer5(BasicBlock5x5, 64, layers[0], stride=4)
        self.layer5x5_2 = self._make_layer5(BasicBlock5x5, 128, layers[1], stride=4)
        self.layer5x5_3 = self._make_layer5(BasicBlock5x5, 256, layers[2], stride=4)
        ...
        self.layer7x7_1 = self._make_layer7(BasicBlock7x7, 64, layers[0], stride=4)
        self.layer7x7_2 = self._make_layer7(BasicBlock7x7, 128, layers[1], stride=4)
        self.layer7x7_3 = self._make_layer7(BasicBlock7x7, 256, layers[2], stride=4)
        ...
        self.fc = nn.Linear(256*3,  len(hparams.genres))
